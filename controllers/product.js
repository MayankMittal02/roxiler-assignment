...
const getAllGraph = asyncWrapper(async (req, res, next) => {
    const { month } = req.query
    const statisticsAPIResponse = await fetch(`https://roxiler-mayank.vercel.app/getgraphs/getStatistics?month=${month}`)
    const barChartAPIResponse = await fetch(`https://roxiler-mayank.vercel.app/getgraphs/getbargraph?month=${month}`)
    const pieChartAPIResponse = await fetch(`https://roxiler-mayank.vercel.app/getgraphs/getpiegraph?month=${month}`)
